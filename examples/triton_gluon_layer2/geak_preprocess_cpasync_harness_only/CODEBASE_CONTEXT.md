...
│   │   ├── 03_elementwise_add_cpasync_amd.py    ← TARGET KERNEL
...
│   │   ├── resolved.json
│   │   └── testcase_selection.json
│   ├── layer2_elementwise_add_geak_20260420_round1/
│   │   ├── benchmark_baseline.txt
│   │   ├── CODEBASE_CONTEXT.md
│   │   ├── discovery.json
│   │   ├── full_benchmark_baseline.txt
...
│   │   ├── resolved.json
│   │   └── testcase_selection.json
│   ├── layer2_elementwise_add_geak_20260420_round1_retry1/
│   │   ├── _working_memory/
│   │   └── ... (19 more)
│   └── ... (1 more)
└── ... (20 more)
...
Target kernel: `examples/triton_gluon_layer2/03_elementwise_add_cpasync_amd.py`
