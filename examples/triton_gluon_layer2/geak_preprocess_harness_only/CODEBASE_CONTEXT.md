...
│   │   │   ├── discovery.json
│   │   │   └── resolved.json
│   │   ├── 03_elementwise_add_amd.py    ← TARGET KERNEL
...
│   │   ├── resolved.json
│   │   └── testcase_selection.json
│   └── triton_gluon_mi3xx_20260417_055346/
│       ├── full_preprocess_amd_mfma/
│       │   ├── baseline_metrics.json
│       │   ├── benchmark_baseline.txt
│       │   ├── CODEBASE_CONTEXT.md
│       │   ├── COMMANDMENT.md
...
│       │   ├── resolved.json
│       │   └── testcase_selection.json
│       ├── full_preprocess_buffer_load_store/
│       │   ├── baseline_metrics.json
│       │   ├── benchmark_baseline.txt
│       │   ├── CODEBASE_CONTEXT.md
│       │   ├── COMMANDMENT.md
...
│       │   ├── resolved.json
│       │   └── testcase_selection.json
│       ├── full_preprocess_inline_with_amdgpu_dialect/
│       │   ├── baseline_metrics.json
│       │   ├── benchmark_baseline.txt
│       │   ├── CODEBASE_CONTEXT.md
│       │   ├── COMMANDMENT.md
...
│       │   ├── resolved.json
│       │   └── testcase_selection.json
│       ├── harness_only_amd_mfma/
│       │   ├── harness_shapes_source.txt
│       │   └── test_test_core_harness.py
│       ├── harness_only_amd_mfma_deterministic/
│       │   ├── benchmark_baseline.txt
│       │   └── ... (10 more)
│       └── ... (6 more)
└── ... (16 more)
...
Target kernel: `examples/triton_gluon_layer2/03_elementwise_add_amd.py`
